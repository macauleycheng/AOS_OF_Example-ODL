...
curl -v -H "Content-Type: application/xml" \
     ...
     -H "Authorization: Basic YWRtaW46YWRtaW4=" \
     -X PUT \
     --data "@./l2-interface-group_port2_vlan300_tag.xml" \
     http://$controller_ip:8181/restconf/config/opendaylight-inventory:nodes/node/$openflow_node/group/19660802

echo "rewrite_group_vlan_200_to_300.xml"
curl -v -H "Content-Type: application/xml" \
     -H "Accept: application/xml" \
     -H "Authorization: Basic YWRtaW46YWRtaW4=" \
     -X PUT \
     --data "@./rewrite_group_vlan_200_to_300.xml" \
     http://$controller_ip:8181/restconf/config/opendaylight-inventory:nodes/node/$openflow_node/group/268435458

     
echo "10_add_port1_allow_rx_tag_vid_200.xml"
curl -v -H "Content-Type: application/xml" \
     -H "Accept: application/xml" \
     -H "Authorization: Basic YWRtaW46YWRtaW4=" \
     -X PUT \
     --data "@./10_add_port1_allow_rx_tag_vid_200.xml" \
